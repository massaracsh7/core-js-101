...
function timeSpanToString(startDate, endDate) {
  ...
  const hours = Math.trunc(date / 3600000).toString().padStart(2, 0);
  const minutes = Math.trunc((date % 3600000) / 60000).toString().padStart(2, 0);
  const seconds = Math.trunc(((date % 3600000) % 60000) / 1000).toString().padStart(2, 0);
  const mili = date.toString().slice(-3);
...
function angleBetweenClockHands(date) {
  ...
  const angleH = 0.5 * (60 * hour + minutes);
